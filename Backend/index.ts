...
app.get(
  "/reviews/latest",
  async (_request: Request, response: Response<GetReviewLatest[]>) => {
...
app.post(
  "/reviews",
  async (request: Request, response: Response<PostReview[]>) => {
    const { comic_id, review_user, review_text, review_rating } =
      request.body as PostReview;
...
app.delete(
  "/reviews",
  async (request: Request, response: Response<DeleteReview[]>) => {
